      ...
      <div className="flex gap-10 md:gap-20 items-end flex-col md:flex-row">
        ...
        <div>
          <p className="lg:w-2/3">
            ...
            <span className="text-green-600"> info@wenju.com</span> or
            telephone on <span className="text-green-600">+44 75 852 346 000</span>
          </p>
        </div>
      </div>
      <div className="flex gap-10 md:gap-20 items-end flex-col md:flex-row pt-20 justify-end">
        <div>
          <p>5 Broken Wharf, London EC4V 3DT</p>
